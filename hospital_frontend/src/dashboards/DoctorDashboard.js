                ...
                <div className="header">
                    <div>
                        <h1 style={{ fontSize: '24px', fontWeight: '700', marginBottom: '4px' }}>
                            {doctorProfile ? `Dr. ${doctorProfile.user?.first_name} ${doctorProfile.user?.last_name}` : 'Doctor Dashboard'}
                        </h1>
                        <p style={{ color: 'var(--text-muted)', fontSize: '14px' }}>Welcome to your medical portal.</p>
                    </div>
                </div>
